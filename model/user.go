...
func GetAllUsers(pageInfo *common.PageInfo, includeDeleted bool) (users []*User, total int64, err error) {
	// Start transaction
	tx := DB.Begin()
	if tx.Error != nil {
...
func SearchUsers(keyword string, group string, startIdx int, num int, includeDeleted bool) ([]*User, int64, error) {
	var users []*User
	var total int64
	var err error
